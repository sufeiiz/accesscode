 ...
 * Created by Alex Samuel
 * countWord method created by Sufei Zhao
 */
...
public class HTTP {
    ...
    // counts the number of times a word appears in the String
    // edited to count "<script" in html documents by changing delimiter to ">"
    public static int countWord(String html, String word) {
