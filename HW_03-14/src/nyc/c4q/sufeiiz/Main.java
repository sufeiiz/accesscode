...
public class Main {
    public static void main(String[] args) {
        ...
        boolean loop = true, monkey = false, play = true;
            ...
            while (loop) {
                ...
                if (answer.equalsIgnoreCase("fight")) {
                    ...
                    if (winPercent <= 2) {
                        ...
                        //TODO: finish restart method
                        // restart();

                        loop = false;
                        continue;
                    }
                } else if (answer.equalsIgnoreCase("capture")) {
                    // 25% chance of passing Level 1 (but capturing monkey can help you later in game)
                    winPercent = random.nextInt(4);
                    if (winPercent <= 2) {
...
//                    while (loop) {
//                        answer = input.next();
//                        if (answer.equalsIgnoreCase("banana")) {
...
//                            break;
//                        } else if (answer.equalsIgnoreCase("turtle")) {
...
//                            gameOver();
//                            return;
//                        } else if (answer.equalsIgnoreCase("mushroom")) {
//                            // 50% change of passing Level 2
...
//
//                if (passcode == 181) {
//                    System.out.println("The walls creak as they slowly open. Inside, you find a treasure box! It must be worth billions of dollars!");
//                    treasure();
//                    break;
